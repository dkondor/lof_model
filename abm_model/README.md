...
Examples of a few cases are given below that were used to generate Fig. 2 in our paper. More simulation runs are in the script [lof_runs_rep.fsh] that performs repeated realizations of the simulation and analysis of temporal patterns in the results, generating the main results in our paper.
